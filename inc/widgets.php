...
class wpdemos_widget extends WP_Widget {

    /** The __construct() method is used to assign an id, title, classname and description to the widget.  */
    public function __construct() {
        parent::__construct(
            'wpdemos_widget', // Base ID
            'wpdemos_widget', // Name
            array( 'description' => __( 'wpdemos_widget', 'text_domain' ), ) // Args
        );
    }
...
//register the widget
add_action( 'widgets_init', 'wpdemos_widget_areas' );

if ( ! function_exists( 'wpdemos_widget_areas' ) ) {

	/** Initializes themes widgets.*/
	function wpdemos_widget_areas() {
		register_sidebar(
			array(
				'name'          => __( 'Footer 1', 'wpdemos' ),
				'id'            => 'footer-col-one',
				'description'   => __( 'Left Footer widget area', 'wpdemos' ),
        ...
        register_sidebar(
			array(
				...
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar', 'wpdemos' ),
